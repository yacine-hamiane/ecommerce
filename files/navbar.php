        ...
        <div class="container text-light">
            <div class="w-100 d-flex justify-content-between">
                <div>
                    ...
                    <a class="navbar-sm-brand text-light text-decoration-none" href="mailto:firstshop.messagerie@gmail.com">firstshop.messagerie@gmail.com</a>
                    <i class="fa fa-phone mx-2"></i>
                    <a class="navbar-sm-brand text-light text-decoration-none" href="tel:00213540160812">0540160812 / 0558674349</a>
                </div>
                <div>
            ...
            <div class="align-self-center collapse navbar-collapse flex-fill  d-lg-flex justify-content-lg-between" id="templatemo_main_nav">
                <div class="flex-fill">
                    <ul class="nav navbar-nav d-flex justify-content-between mx-lg-auto">
                        ...
                        <li class="nav-item">
                            <a class="nav-link  <?php  ?>" href="contact.php"><?= lang('contact'); ?></a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link <?php if(isset($_SESSION['client'])){echo 'd-none';} ?>" href="connexion.php"><?= lang('connexion'); ?></a>
                        </li>

                        <li class="nav-item">
                            <a class="nav-link <?php if(!isset($_SESSION['client'])){echo 'd-none';} ?>" href="logout.php"><?= lang('deconnexion'); ?></a>
                        </li>

                        <li class="nav-item">
                            <a class="nav-link <?php if(isset($_SESSION['client'])){echo 'd-none';} ?>" href="inscription.php"><?= lang('inscription'); ?></a>
                        </li>
